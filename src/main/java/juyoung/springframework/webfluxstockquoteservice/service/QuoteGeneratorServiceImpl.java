...
public class QuoteGeneratorServiceImpl implements QuoteGeneratorService{
    ...
    public QuoteGeneratorServiceImpl(){
        ...
        this.prices.add(new Quote("IBM" , 176.86));
        this.prices.add(new Quote("MSFT" , 190.56));
        this.prices.add(new Quote("INTC" , 150.17));
        this.prices.add(new Quote("GOOG" , 160.89));
    }
    ...
    public Flux<Quote> fetchQuoteStream(Duration period) {
        return Flux.generate(()-> 0,
                ...
                .log("juyoung.springframework.service.QuoteGenerator");
    }
